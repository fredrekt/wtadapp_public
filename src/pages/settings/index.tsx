					...
					<Col xs={24} sm={24} md={18} lg={10} xl={10} xxl={10}>
						<Card>
							...
							>
								...
								<Form.Item label="Business name" name="username">
									<Input />
								</Form.Item>

								<Form.Item className="formButton" label="Change Password">
									<Button type="primary">Change</Button>
								</Form.Item>

								<Form.Item className="formButton" label="Change Email">
									<Button type="primary">Change</Button>
								</Form.Item>

								<Form.Item className="formButton" label="Change Mobile number">
									<Button type="primary">Change</Button>
								</Form.Item>
