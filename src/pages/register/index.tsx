						...
						<Col xs={20} sm={20} md={12} lg={5} xl={5} xxl={5}>
							<Card className="registerCardContainer">
								...
								<Input.Password
									...
									onChange={onChange}
								/>
								<CountryPhoneInput defaultValue={{ short: 'SA' }} onChange={(e: any) => setFormData({ ...formData, phone: e.phone })} size="large" className='registerPhone' placeholder='Mobile number' />
						...
						<Col xs={20} sm={20} md={20} lg={20} xl={20} xxl={20}>
							<Card className="registerChooseSetup">
								...
								<div className="chooseSetupCta">
									<Button disabled={!chooseSetup} type="primary" size="large" onClick={onRegister}>
										NEXT
									</Button>
								</div>
							</Card>
