                ...
                {step !== 1 && step !== 0 && <Col span={20}>
                    <Card className='registerChooseSetup'>
                        ...
                        <Typography.Paragraph className='chooseSetupSubTxt'>
                            {step <= 2 ? `You must choose the method of calculating points that is appropriate for your business.` : `You can test the platform for 7 days and generate loyalty cards for your customers`}
                        ...
                        {step === 2 && <Row gutter={40} align={'middle'} justify={'center'} className="chooseSetupSelectionContainer">
                            <Col span={6}>
                                <SetupSelection 
                                    activeSetup={chooseSetup} currentSetup={1}
                            ...
                            <Col span={6}>
                                <SetupSelection 
                                    activeSetup={chooseSetup} currentSetup={2}
                                    onClick={(setup: number) => setChooseSetup(setup)}
                        ...
                        <div className="chooseSetupCta">
                            {step <= 2 ? <Button disabled={!chooseSetup} type='primary' size="large" onClick={() => setStep(step + 1)}>NEXT</Button> : <Button onClick={onSubscribe} type='primary' size="large">Subscribe now</Button>}
                        </div>
                    </Card>
                </Col>}
            </Row>
